# Project Name
第二周作业：Implemented a multi-class classification task using PyTorch on a synthetic dataset, 
           where the class label is determined by the index of the maximum value in a randomly generated vector.
